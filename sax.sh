...
output_path="horimiya13" # Output Path (Same will be pushed in main also)
input_url="https://mirror.shakida-index.workers.dev/S1%20-%20E13%20Horimiya%20%5B720p%5D%20%5BDub%5D%20%40TSW_Anime.mkv" # Input direct file url
...
#  -vf scale=w=426:h=240:force_original_aspect_ratio=decrease -c:a aac -ar 48000 -c:v h264 -profile:v main -crf 20 -sc_threshold 0 -g 48 -keyint_min 48 -hls_time 4 -hls_playlist_type vod  -b:v 400k -maxrate 456k -bufsize 600k -b:a 96k -hls_segment_filename $output_path/240p_%03d.ts $output_path/240p.m3u8 \
